...
# Run from Re = 2
#Re_target = 2.0
#run_label = "Re2_from_rest"   # change this each run
#restart_mode = "none"         # choices: "none", "u_only", "full"
#restart_file = ""             # e.g. "Re2_from_rest/checkpoints/checkpoints_s1.h5"
#restart_index = -1            # -1 means last saved write

Re_target = 10
run_label = "Re10_refine_from_Re10"
restart_file = "Re10_from_Re9/snapshots/snapshots_s1.h5"
...
try:
    while solver.proceed:
        ...
        if (solver.iteration - 1) % 50 == 0:
            ...
            logger.info(
                f"iter={solver.iteration:6d} t={t_phys:9.4f} "
