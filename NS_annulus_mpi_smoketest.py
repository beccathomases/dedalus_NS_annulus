...
base_run_root = "/work/pi_shuzhou_umass_edu/bthomases_smith_edu/runs/dedalus_NS_annulus"
case_label = "unity_test"
segment_label = "seg01_smalltest"
run_dir = os.path.join(base_run_root, case_label, segment_label)

#case_label = "Re40_caseB"
#segment_label = "seg01_from_rest_snap0p1"   # new folder for this piece of the run
#run_dir = os.path.join(case_label, segment_label)
