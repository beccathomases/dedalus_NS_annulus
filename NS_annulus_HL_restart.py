...
Re_target = 7.5
run_label = "Re7p5_from_Re7"
restart_file = "Re7_from_Re6/snapshots/snapshots_s1.h5"
restart_mode = "u_only"
restart_index = -1
stop_sim_time = 10.0
bc_time_offset = 0.0
...
if restart_mode == "full":
    ...
    # Use only old velocity as the new initial condition
    ...
    # Reset auxiliary fields for the new solve
    p['g'] = 0
    tau_p['g'] = 0
    tau_u1['g'] = 0
    tau_u2['g'] = 0
